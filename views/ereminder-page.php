...
<div class="wrap ereminder">
	...
	<form method="POST" action="">
		<p class="field">
			<label for="pd-reminder-content"><?php _e( 'Enter your reminder', 'email-reminder' ); ?></label><br />
		...
		<p class="field">
			<label for="pd-reminder-email" title="Leave this field blank to send email to yourself"><?php _e( 'Email address to send reminder to', 'email-reminder' ); ?></label><br />
			<input type="email" size="40" name="pder[email]" id="pd-reminder-email" placeholder="<?php _e( 'youremailaddress@email.com', 'email-reminder' ); ?>" title="<?php _e( 'Where to email the reminder to. Leave this field blank to send email to yourself', 'email-reminder' ); ?>" value="<?php echo $fields['email']; ?>" />
		</p>
		<p class="field">
			<label for="pd-reminder-date"><?php _e( 'When to send reminder', 'email-reminder' ); ?></label><br />
			<input type="text" size="20" name="pder[date]" id="pd-reminder-date" value="<?php echo $fields['date']; ?>" placeholder="<?php _e( 'YYYY-MM-DD', 'email-reminder' ); ?>" title="<?php _e( 'Set the date for the reminder (Format: YYYY-MM-DD)', 'email-reminder' ); ?>" />
	...
	<div class="reminder-list pder-sent">
		...
		?>
		<h3><?php _e( 'Sent Reminders', 'email-reminder' ); ?> <a href="<?php echo esc_url( $delete_all_link ); ?>" class="button-secondary"><?php _e( 'Delete all sent reminders', 'email-reminder' ); ?></a></h3>
		<?php
			global $wpdb;
